...
extension SecondStageView {
    
    private func setConstraints() {
        NSLayoutConstraint.activate([
        
            secondStageLabel.topAnchor.constraint(equalTo: topAnchor, constant: 40),
            secondStageLabel.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 32),

            countEnginesLabel.topAnchor.constraint(equalTo: secondStageLabel.bottomAnchor, constant: 16),
